...
Given a set of $n$ objects expressing both a point and some other secondary property, we can create a composite structure whereby the point can be queried by a half-plane and the secondary property can be queried by a given secondary algorithm with S, T, Q in (i), (ii).
